...
HD_PWD='/home/hicksze1/Pluto-PYNQ/Pluto/base/system/pluto.runs/system_cdc_sync_active_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_cdc_sync_active_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_cdc_sync_active_1.tcl
