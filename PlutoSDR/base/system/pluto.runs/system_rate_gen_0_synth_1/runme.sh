...
HD_PWD='/home/hicksze1/Pluto-PYNQ/Pluto/base/system/pluto.runs/system_rate_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rate_gen_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rate_gen_0.tcl
