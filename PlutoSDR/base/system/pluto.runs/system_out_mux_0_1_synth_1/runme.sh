...
HD_PWD='/home/hicksze1/Pluto-PYNQ/Pluto/base/system/pluto.runs/system_out_mux_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_out_mux_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_out_mux_0_1.tcl
