...
-- Command     : write_vhdl -force -mode funcsim -rename_top system_cdc_sync_active_0 -prefix
--               system_cdc_sync_active_0_ system_cdc_sync_active_0_sim_netlist.vhdl
...
entity system_cdc_sync_active_0_sync_bits is
  port (
...
end system_cdc_sync_active_0_sync_bits;

architecture STRUCTURE of system_cdc_sync_active_0_sync_bits is
...
entity system_cdc_sync_active_0 is
  ...
  attribute NotValidForBitStream of system_cdc_sync_active_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_cdc_sync_active_0 : entity is "system_cdc_sync_active_0,sync_bits,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_cdc_sync_active_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_cdc_sync_active_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_cdc_sync_active_0 : entity is "sync_bits,Vivado 2022.1";
end system_cdc_sync_active_0;

architecture STRUCTURE of system_cdc_sync_active_0 is
...
begin
inst: entity work.system_cdc_sync_active_0_sync_bits
     port map (
      in_bits(0) => in_bits(0),
