...
-- Command     : write_vhdl -force -mode funcsim -rename_top system_cpack_0 -prefix
--               system_cpack_0_ system_cpack_0_sim_netlist.vhdl
...
entity system_cpack_0_pack_network is
  port (
...
end system_cpack_0_pack_network;

architecture STRUCTURE of system_cpack_0_pack_network is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_cpack_0_pack_shell is
  port (
...
end system_cpack_0_pack_shell;

architecture STRUCTURE of system_cpack_0_pack_shell is
...
\gen_network[0].i_ctrl_interconnect\: entity work.system_cpack_0_pack_network
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_cpack_0_util_cpack2_impl is
  port (
...
end system_cpack_0_util_cpack2_impl;

architecture STRUCTURE of system_cpack_0_util_cpack2_impl is
...
begin
i_pack_shell: entity work.system_cpack_0_pack_shell
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_cpack_0_util_cpack2 is
  port (
    packed_fifo_wr_data : out STD_LOGIC_VECTOR ( 63 downto 0 );
    packed_fifo_wr_en : out STD_LOGIC;
    packed_fifo_wr_sync : out STD_LOGIC;
...
end system_cpack_0_util_cpack2;

architecture STRUCTURE of system_cpack_0_util_cpack2 is
begin
i_cpack: entity work.system_cpack_0_util_cpack2_impl
     port map (
      D(3 downto 0) => D(3 downto 0),
      clk => clk,
      fifo_wr_data_0(15 downto 0) => fifo_wr_data_0(15 downto 0),
...
entity system_cpack_0 is
  ...
  attribute NotValidForBitStream of system_cpack_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_cpack_0 : entity is "system_cpack_0,util_cpack2,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_cpack_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_cpack_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_cpack_0 : entity is "util_cpack2,Vivado 2022.1";
end system_cpack_0;

architecture STRUCTURE of system_cpack_0 is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME packed_fifo_wr_signal_clock, ASSOCIATED_BUSIF packed_fifo_wr, ASSOCIATED_RESET reset, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_axi_ad9361_0_l_clk, INSERT_VIP 0";
...
inst: entity work.system_cpack_0_util_cpack2
     port map (
      D(3) => enable_3,
      D(2) => enable_2,
      D(1) => enable_1,
